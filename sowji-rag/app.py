...
uri = "mongodb+srv://simplysowj:Sairam@cluster0.96b5s.mongodb.net/?retryWrites=true&w=majority"
...
with st.expander("⚠️Disclaimer"):
    st.write("""This is a work in progress chatbot based on a large language model. It can answer questions about me""")

path = os.path.dirname(__file__)


# Loading prompt to query openai
prompt_template = r"C:\Users\simpl\Downloads\chatbot-document\resumeGPT\templates\template.json"
prompt = load_prompt(prompt_template)
#prompt = template.format(input_parameter=user_input)

# loading embedings
#faiss_index = r"C:\Users\simpl\Downloads\chatbot-document\resumeGPT\faiss_index"

# Loading CSV file
data_source = r"C:\Users\simpl\Downloads\chatbot-document\resumeGPT\data\about_me.csv"
pdf_source = r"C:\Users\simpl\Downloads\chatbot-document\resumeGPT\data\resume.pdf"
...
def conversational_chat(query):
    with st.spinner("Thinking..."):
        ...
        result = chain({"system": 
        "You are a Sowjanya's ResumeGPT chatbot, a comprehensive, interactive resource for exploring Sowjanya's background, skills, and expertise. Be polite and provide answers based on the provided context only. Use only the provided data and not prior knowledge.", 
                        "question": query, 
    ...
    if ('I am tuned to only answer questions' in response) or (response == ""):
        full_response = """Unfortunately, I can't answer this question. My capabilities are limited to providing information about Sowjanya's professional background and qualifications. If you have other inquiries, I recommend reaching out to Sowji on simplysowj@gmail.com. I can answer questions like: \n - What is Sowjanya's educational background? \n - Can you list Sowjanya's professional experience? \n - What skills does Sowjanya possess? \n"""
...
if "messages" not in st.session_state:
    ...
    with st.chat_message("assistant"):
        ...
        welcome_message = """
            Welcome! I'm **Sowjanya's ResumeGPT**, specialized in providing information about her professional background and qualifications. Feel free to ask me questions such as:
